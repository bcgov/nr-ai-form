...
inputs = {
  ...
  # Container Apps uses the same subnet as private endpoints
  dev_container_apps_subnet_id   = "/subscriptions/56358ccd-64df-4586-98cc-f472e4c7323f/resourceGroups/d94cca-dev-networking/providers/Microsoft.Network/virtualNetworks/d94cca-dev-vwan-spoke/subnets/css-ai-services-subnet-2"
}
