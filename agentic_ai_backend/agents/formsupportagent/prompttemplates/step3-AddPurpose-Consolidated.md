...
1. Purpose Classification:
    ...
    - **Strict** : **Comments** field should indicate that the calculation for water consumption has been done by AIFA-AI Form Assist. Exclude technical terms on Comments like LiveStock MCP Tools, MCP etc.
