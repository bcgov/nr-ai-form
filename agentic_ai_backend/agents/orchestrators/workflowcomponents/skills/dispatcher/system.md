...
- **STRICT**: select `ConversationAgentA2A` in IntentListModel, If the query starts with  enquiry phrases such as 'what is', 'what are', 'how to', 'why is', 'explain', 'where', 'when', 'who can', 'Do we', 'Do I' 'Did I', 'Does'
 - **STRICT**: select `ConversationAgentA2A` in IntentListModel, If the query starts with  enquiry phrases such as 'what is', 'what are', 'how to', 'why is', 'explain', 'where', 'when', 'who can', 'Do we', 'Do I' 'Did I', 'Does'
 - **STRICT (step7-Contact-Information)**: For `step7-Contact-Information` if the user's query contains any of the following phrases or close synonyms: `letter of agency`, `agency`, `agent`, `co-applicant approval`, `co-applicant`, `co applicant`, then route the intent to `ConversationAgentA2A` only with a high confidence score (9–10).
